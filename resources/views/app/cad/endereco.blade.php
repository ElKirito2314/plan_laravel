    ...
    <div class="fundo-claro">
        ...
        @endif
            ...
            <div class="conteudo-pagina">
                ...
                <div class="input-wrapper">
                    <input name="maps" class="custom-input @error('maps') is-invalid @enderror" value="{{ $endereco->maps ?? old('maps') }}" type="text" placeholder="Endereço MAPS">
                    @error('maps')
                        <i class="bi bi-exclamation-circle position-absolute error-icon"></i>
                    @enderror
                </div>
                <span class="custom-invalid-feedback" role="alert">
                    {{ $errors->has('maps') ? $errors->first('maps') : '' }}
                </span>
